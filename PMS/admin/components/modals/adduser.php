        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <form action="../includes/signup.inc.php" method="POST">
                    ...
                    <div class="mb-6">
                        <label for="roleID" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        ...
                        <button data-modal-hide="staticModal" name="register" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Employee</button>
