            ...
            <div class="p-6 space-y-6">
                <form action="../includes/signup.inc.php" method="POST">
                    <div class="mb-6">
                        ...
                        <select  name="emp_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            while ($row = mysqli_fetch_array($result_employees)) { ?>
                                <option value='<?php echo $row[0] ?>'> <?php echo ucwords($row[1]) ?> <?php echo ucwords($row[2]) ?> <?php echo ucwords($row[3]) ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        ...
                        <button data-modal-hide="adduserModalID" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Decline</button>
                    </div>
                </form>
            </div>
