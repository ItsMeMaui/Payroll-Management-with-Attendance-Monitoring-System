                ...
                <form action="../includes/update.inc.php" method="POST" enctype="multipart/form-data">
                    <div class="flex flex-col md:flex-row gap-5">
                        ...
                        <div class="flex justify-center items-center flex-col gap-5">
                            <img draggable="false" id="editImage" alt="your image" class="rounded-full border-2 w-64 h-64" />
                        ...
                        <div class="flex flex-col gap-5 md:ml-10">
                            ...
                            <div class="flex flex-col md:flex-row gap-5">
                                <div class="flex flex-col">
                                    <label for="fingerprintIDvalue" class="block mb-2 text-md font-medium text-gray-900 dark:text-white"><span class="text-red-500">*</span>Fingerprint ID</label>
